...
#                    'channel:\n' + message.channel.name + '\nauthor:\n' + message.author.name + '\ncontent:\n' + message.content)
    ...
    if message.channel.id in [1073989056565878796,1073947096807391283] and message.author.name != bot.user.name:
        a=random.randint(0,10)
        if a>=5:
...
# p.daemon=True
# p.start()
bot.run('OTk5MjM3ODQ0MDc1ODA2NzMz.GB8bdc.7Kc3E3GSPzIgn7OkRIAxGEMuda4SusMrHuwtmU')
