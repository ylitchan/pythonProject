...
driver = webdriver.Edge(options=options, service=service)
driver.get("https://www.facebook.com/sukhee.baterdene.75/friends")
WebDriverWait(driver, 60).until(
    EC.visibility_of_element_located((By.XPATH, '//div[@class="_4g34 _5pxb _5i2i _52we"]/div[@class="_5xu4"]')))
# cookies = [
#     {
#         "domain": ".twitter.com",
#         "expirationDate": 1723282374,
...
# time.sleep(5)
# 载入所有页面
a = open('facebook2.txt', 'w', encoding='utf-8')
while True:
    ...
    if newcheck_height == check_height:
        break
followingdata = driver.find_elements(By.XPATH,
                                     '//div[@class="_4g34 _5pxb _5i2i _52we"]/div[@class="_5xu4"]')
for i in followingdata:
    print(i.text)
    a.write(i.text + '\n')
