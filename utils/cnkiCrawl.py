...
k = {
    ...
    # '军事智能': ['军事人工智能', '军事智能网络分析', '军事自主决策', '作战自主导航', '战场大数据分析与云计算',
    #              '网络空间作战技术', '战场仿真与虚拟现实技术', '军事智能指挥控制系统', '战场模拟', '反蜂群',
    #              '反卫星', '反隐形战机', 'Anti-swarm', 'anti-satelliteanti-submarine', 'anti-stealth fighter',
    #              'Military Artificial', 'Military Intelligence', 'Military Autonomous',
    #              'Operational Autonomous Navigation', 'Cyber Warfare Technology', 'Battlefield Modeling'],
    # '战场通信': ['军事通信', '作战通信', '战场通信', '战场无线电', '战场短波', '战场超短波', '战场微波',
    ...
    '海战武器装备': [
        ...
        'Cyber Weapon', '高超声速导弹',
        '高超声速滑翔弹头', 'HGV', '高超声速巡航导弹', 'HCM', '高超声速战术导弹',
        ...
        'hypersonic aircraft', '新概念武器', '定向能武器', 'Directed Energy Weapons', '激光武器',
        '固态激光武器',
        'Solid-State Laser Weapons', '气体激光武器 ', 'Gas Laser Weapons', '光纤激光武器 ',
        'Fiber Laser Weapons', '自由电子激光 ', 'Free Electron Laser', '便携式激光武器',
        'Portable Laser Weapons', '高能激光武器 ', 'High-Energy Laser Weapons', '微波武器',
        '电磁武器',
        'Electromagnetic Weapons', '电磁炮', '电磁脉冲武器', 'EMP', '生物武器 ', 'Bioweapons',
            ...
            for e in list_data:
                ...
                while isinstance(res, str) or '系统检测到您的访问行为异常，请帮助我们完成' in res.text:
                    try:
                        ...
                        traceback.print_exc()
                        continue
                bar_url = Selector(text=res.text).xpath('//li[@class="btn-html"]//@href').get()
                if not bar_url:
                ...
                if bar_url:
                    ...
                    while res.status_code == 302:
                        ...
                        if 'https://bar.cnki.net/bar/verify/index.html?' in url302 or 'ErrorMsg.html?' in url302:
                    ...
                    try:
                        ...
                        # except Exception as e:
                        #     traceback.print_exc()
                        print('已入库', item['original_title_translate'])
