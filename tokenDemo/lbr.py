        ...
        for biaoqian in biaoqians:
            try:
                ...
                if 'lybra-finance' not in biaoqian.tokens:
                    ...
                    lbr = biaoqian.tab.ele('xpath://*[@class="earn_tabItem__ST764"][1]//div[.//img]').text.strip().split(
                        ' ')[0].strip()
                    if lbr:
...
async def main():
    ...
    lbr = Biaoqian(page.get_tab('8439534C60028FD6B651D9F58ECB5420'), ['lybra-finance'])
