                ...
                "articles": [
                    {
                        "title": "会所嫩模领取",
                        "description": "",
                        "url": "https://www.iwencai.com/unifiedwap/result?w=%E6%98%A8%E6%97%A5%E6%94%BE%E9%87%8F%E6%B6%A8%E5%81%9C%3B%E4%BB%8A%E6%97%A5%E7%AB%9E%E4%BB%B7%E6%8A%A2%E7%AD%B9%E9%AB%98%E5%BC%80%3B%E7%AB%9E%E4%BB%B7%E5%BC%82%E5%8A%A8%E8%AF%B4%E6%98%8E%3B%E6%98%A8%E6%97%A5%E6%B6%A8%E5%81%9C%E5%8E%9F%E5%9B%A0%E7%B1%BB%E5%88%AB%3B%E9%9B%86%E5%90%88%E7%AB%9E%E4%BB%B7%E8%AF%84%E7%BA%A7&querytype=stock",
...
def bn(symbol, symbols_asset, alert_b):
    try:
        kline_hour = [[float(i) for i in sub] for sub in client.klines(symbol=symbol, interval="15m", limit=4)[:3]]
        ...
        if price_close >= price_open:
            ...
            kline_vol = next(filter(
                lambda x: kline_hour[x][4] / kline_hour[x - 1][4] >= 1.0333687020354 and price_close >= kline_hour[x][
                    ...
                    max(kline_hour[:x], key=lambda y: y[5])[5], kline_hour[-1][5]), range(1, 2)), None)
            if kline_vol:
