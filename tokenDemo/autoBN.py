                ...
                if (
                    (
                        ...
                        or (
                            ...
                            != "LONG"
                            and (kline[-1][2] < kline[-1][1] * (1 + kline_zf_15))
                        )
                    )
                    ...
                    # 设置止盈止损：止盈9%，止损9%
                    zy = kline_close[-1] * (1 + kline_zf_15)  # 止盈价
                    zs = kline_close[-1] * (1 - kline_zf_15)  # 止损价
                ...
                # 条件3：持仓量增加信号（increase_oi函数返回True）
                    ...
                    (
                        ...
                        or (
                            ...
                            != "SHORT"
                            and (kline[-1][3] > kline[-1][1] * (1 - kline_zf_15))
                        )
                    )
